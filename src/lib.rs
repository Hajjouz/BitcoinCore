...
#[derive(Debug)]
pub struct BitcoinCoreProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BitcoinCoreProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BitcoinCore processing");
    
    let mut processor = BitcoinCoreProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BitcoinCoreProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BitcoinCoreProcessor::new(false);
